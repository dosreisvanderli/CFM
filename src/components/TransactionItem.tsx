...
const TransactionItemComp: React.FC<TransactionItemProps> = ({ 
  ...
  return (
    <View style={[styles.itemCard, { backgroundColor: theme.card, flexDirection: 'row', alignItems: 'center', paddingVertical: 0, paddingHorizontal: 2 }]}>
      ...
      <TouchableOpacity onPress={() => onToggleSelection(item.id)} style={{ paddingRight: 6, paddingVertical: 0 }}>
        <View style={{
          width: 16, 
          height: 16, 
          borderRadius: 4, 
      ...
      <TouchableOpacity style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }} onPress={() => onToggleSelection(item.id)}>
